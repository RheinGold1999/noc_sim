...
INIT_PARAM(NocConfig, int, network_lvl_0_num, 9, "network level 0 number (should contain NodeRouters and BridgeRouters in case of the Ring structure)")
...
INIT_PARAM(NocConfig, int, network_lvl_0_bridge_num, 1, "network level 0 bridge number")
